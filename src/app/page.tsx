    ...
    <main>
      <nav className="flex items-center justify-between flex-wrap px-6 py-4">
        ...
        <div className="block lg:hidden">
          <button className="flex items-center px-3 py-2 border rounded text-foreground border-teal-400  hover:border-white">
            <svg
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto gap-2">
          <div className="text-sm lg:flex-grow">
            <a
              ...
              className="block mt-4 lg:inline-block lg:mt-0 text-foreground mr-4"
            >
              Docs
            </a>
            <a
            ...
            <a
              href="#responsive-header"
              className="block mt-4 lg:inline-block lg:mt-0 text-foreground"
            >
              Blog
            </a>
          </div>
